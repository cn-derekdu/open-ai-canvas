...
import { loadAssetsPage, loadCanvasPage, loadCanvasProjectPage, loadCreatePage, loadProjectDetailPage, loadProjectsPage, loadPromotionPage, loadWalletPage } from "@/lib/workspace-route-modules";
